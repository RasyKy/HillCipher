...
function EncryptSection({
    ...
    return (
      <div className="flex-1 space-y-2 text-left max-w-120">
        ...
        <AlphabetOptions alphabetOption={alphabetOption} setAlphabetOption={setAlphabetOption} namePrefix="alphabet" />
        ...
        <div>
          ...
          <textarea className="w-full h-24 text-black outline-0 bg-stone-300 p-2" value={encryptResult} readOnly />
        </div>
      </div>
    );
  }
